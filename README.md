...
** See the framework, dims/operations used and note that python and R read .nc files differently before using/modifying code to save yourself a headache of playing with (X) dimensions in your head between variables and programs.**
