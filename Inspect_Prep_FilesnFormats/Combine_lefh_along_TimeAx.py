...
OUTPUT_PATH = '/Volumes/WD Backup/Rowe_FVCOM_data/Temporary_redoconcatdates'  #'/Volumes/WD Backup/Rowe_FVCOM_data/FVCOMvol_Claude_042025' # '/Volumes/WD Backup/Rowe_FVCOM_data/Outputs_Volumes_rnd2'

# Get a list of all files matching the pattern "spatial_summary_*.nc" in the OUTPUT_PATH.
processed_files = glob(os.path.join(OUTPUT_PATH, "spatial_summary_3D*.nc"))
...
for file in files_to_process:
    ...
    output_daily_file = os.path.join(OUTPUT_PATH, f"spatial_summary_3D_{year}_1.nc")
